...
class MockPaymentProvider(BasePaymentProvider[MockOptions]):
    ...
    async def _prepare_options(cls, create_bill_context: CreateBillContext,
                               account_service: "AccountService") -> MockOptions:
        return MockOptions(account_id=create_bill_context.account_id)
