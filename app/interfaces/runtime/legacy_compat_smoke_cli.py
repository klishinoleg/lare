...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run Lazy Reader legacy frontend compatibility smoke over HTTP.",
    )
    parser.add_argument(
        "--api-root",
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Synthetic Telegram user id. Defaults to a random compat id.",
    )
    parser.add_argument(
        "--seed",
        default=None,
        help="Stable suffix for generated names and synthetic payment ids.",
    )
    parser.add_argument(
