...
class ChapterCreateRequestedEventHandler(BaseEventHandler[ChapterCreateRequestedEvent, ChapterCreationErrorEvent]):
    ...
    async def handler(cls, event: ChapterCreateRequestedEvent) -> None:
        """
        ...
        await DIPublisher[ChapterCreateRequestedEvent, ChapterCreationErrorEvent].publish(
